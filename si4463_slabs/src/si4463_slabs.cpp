...
int8_t SI4463_ReadRxFifo(const si4463_t * si4463, uint8_t * msg, const uint16_t msgLen)
{
	...
	uint8_t cmdBuf[msgLen_MAX + 1];
	memset(cmdBuf, 0x00, msgLen_MAX + 1);

	uint8_t command[msgLen_MAX+1];
	memset(command, 0, msgLen_MAX+1);
