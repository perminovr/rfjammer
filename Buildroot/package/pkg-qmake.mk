...
define $(2)_CONFIGURE_CMDS
	$$(QT5_QT_CONF_FIXUP)
	cd $$($(2)_BUILDDIR) && mkdir -p build && cd build && \
...
define $(2)_BUILD_CMDS
	$$(TARGET_MAKE_ENV) $$($(2)_MAKE_ENV) $$(MAKE) -C $$($(2)_BUILDDIR)/build $$($(2)_MAKE_OPTS)
endef
endif
...
define $(2)_INSTALL_STAGING_CMDS
	$$(TARGET_MAKE_ENV) $$($(2)_MAKE_ENV) $$(MAKE) -C $$($(2)_BUILDDIR)/build $$($(2)_INSTALL_STAGING_OPTS)
endef
endif
...
define $(2)_INSTALL_TARGET_CMDS
	$$(TARGET_MAKE_ENV) $$($(2)_MAKE_ENV) $$(MAKE) -C $$($(2)_BUILDDIR)/build INSTALL_ROOT=$$($(2)_BUILDDIR)tmp-target-install $$($(2)_INSTALL_TARGET_OPTS)
